      ...
      res=> {
        this.lt=[]
          ...
          for (let i = 0; i < JSON.parse(res.Org1).length; i++) {
            for(let j = 0; j < JSON.parse(res.Org1)[i].Value.length; j++) {
              console.log("******************************************************************************************************************************************************************************************************************************")
              console.log("VALUES",JSON.parse(res.Org1)[i].Value[j])
              // console.log(this.show_fy_year)
              console.log("******************************************************************************************************************************************************************************************************************************")
              if(parseInt(JSON.parse(res.Org1)[i].Value[j].YEAR) == parseInt(this.fy_year)) {
                this.lt.push(["Org1",JSON.parse(res.Org1)[i].Value[j]])
              }
            }
          ...
          for (let i = 0; i < JSON.parse(res.Org2).length; i++) {
            for(let j = 0; j < JSON.parse(res.Org2)[i].Value.length; j++) {
              ...
              // console.log(this.show_fy_year)
              console.log("******************************************************************************************************************************************************************************************************************************")
              if(parseInt(JSON.parse(res.Org2)[i].Value[j].YEAR) == parseInt(this.fy_year)) {
